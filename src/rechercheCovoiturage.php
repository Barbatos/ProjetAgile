...
<form action="rechercheCovoiturage.php" methode="POST">
	...
	<input type="text" name="date1" id="date1" onclick="ds_sh(this);" <?php isErreur('date1'); ?> /><br/><br/>
	
	<label for="heureD">Heure de depart: </label><br/>
	<input type="text" name="heureD" class="hourPicker" id="heureD" <?php isErreur('heureD'); ?> /><br/><br/>
